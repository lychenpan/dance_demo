...
class PosenetActivity :
  ...
  private var
          imageAvailableListener = object : OnImageAvailableListener {
...
//    val person = posenet.estimateSinglePose(scaledBitmap)
  ...
  //TODO  this cameara's referesh techinique need to research;

  /** Draw bitmap on Canvas.   */
  private fun drawMutiPerson(canvas: Canvas, persons: Array<Person?>, bitmap: Bitmap) {
    canvas.drawColor(Color.TRANSPARENT, PorterDuff.Mode.CLEAR)
    // Draw `bitmap` and `person` in square canvas.
    val screenWidth: Int
    val screenHeight: Int
    ...
    canvas.drawText(
      "Score: %.2f".format(persons[0]?.score),
      (15.0f * widthRatio),
      (30.0f * heightRatio + bottom),
      paint
    )
